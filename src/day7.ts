...
const stringEcho  = (arg:string):string => arg;// this not generic function
...
const userArray = [
  ...
  console.log(getUserProperty(userArray,'company'))
...
const store2 = new StateObject([1,2,34]);
console.log(store2.state)
store2.state =[1,23,4]
console.log(store2.state)

const store3 = new StateObject<(string|number|boolean)[]>([15]);
